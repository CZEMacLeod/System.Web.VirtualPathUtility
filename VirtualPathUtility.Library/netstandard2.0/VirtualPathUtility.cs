...
public static class VirtualPathUtility
{
	...
	public static string AppendTrailingSlash(string virtualPath) => throw new NotImplementedException();
	...
	public static string Combine(string basePath, string relativePath) => throw new NotImplementedException();
	...
	public static string GetDirectory(string virtualPath) => throw new NotImplementedException();
	...
	public static string GetExtension(string virtualPath) => throw new NotImplementedException();
	...
	/// <exception cref="T:System.ArgumentException">
	///   <paramref name="virtualPath" /> contains one or more characters that are not valid, as defined in <see cref="F:System.IO.Path.InvalidPathChars" />. </exception>
	public static string GetFileName(string virtualPath) => throw new NotImplementedException();
	...
	public static bool IsAbsolute(string virtualPath) => throw new NotImplementedException();
	...
	/// <exception cref="T:System.ArgumentNullException">
	///   <paramref name="virtualPath" /> is null.</exception>
	public static bool IsAppRelative(string virtualPath) => throw new NotImplementedException();
	...
	public static string MakeRelative(string fromPath, string toPath) => throw new NotImplementedException();
	...
	public static string RemoveTrailingSlash(string virtualPath) => throw new NotImplementedException();
	...
	public static string ToAbsolute(string virtualPath) => throw new NotImplementedException();
	...
	public static string ToAbsolute(string virtualPath, string applicationPath) => throw new NotImplementedException();
	...
	/// <exception cref="T:System.ArgumentException">
	///   <paramref name="virtualPath" /> is null. </exception>
	public static string ToAppRelative(string virtualPath) => throw new NotImplementedException();

	/// <summary>Converts a virtual path to an application-relative path using a specified application path.</summary>
	/// <returns>The application-relative path representation of <paramref name="virtualPath" />.</returns>
	/// <param name="virtualPath">The virtual path to convert to an application-relative path. </param>
	/// <param name="applicationPath">The application path to use to convert <paramref name="virtualPath" /> to a relative path. </param>
	public static string ToAppRelative(string virtualPath, string applicationPath) => throw new NotImplementedException();
}
#endif
